...
world_inc_allyears = world %>% right_join(burden %>% select(iso3, year, e_inc_100k, e_mort_100k), by = c('iso_a3' = 'iso3'))
...
# plot deaths maps for all years
gg_death_maps = ggplot(data = world_inc_allyears) +
...
ggsave('figures/death_maps.png', plot = gg_death_maps, scale = 1.5)
...
ggsave('figures/death_maps_2018.png', plot = gg_death_maps_2018, scale = 1.5)